...
本项目的性能报告是基于2024/01/20的VMamba代码测试的。两个月以来，VMamba的第一作者[刘悦](https://github.com/MzeroMiko)已对其进行了多次重大的版本迭代导致我已经看不懂现在版本的VMamba代码了。所以关于这一项目的VMamba部分，等我什么时候看懂了什么时候再更新（笑）。

最近更新的是Swin的cfg之类的一些东西，都是乱写的，还不一定写对。
