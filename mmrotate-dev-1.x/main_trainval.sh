model[1]="rotated-faster-rcnn-le90_swin-tiny_fpn_1x_dota_le90"
model[2]="rotated-faster-rcnn-le90_swin-small_fpn_1x_dota_le90"
model[3]="rotated-faster-rcnn-le90_swin-base_fpn_1x_dota_le90"
