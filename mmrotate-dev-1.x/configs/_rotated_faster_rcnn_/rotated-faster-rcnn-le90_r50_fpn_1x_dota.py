_base_ = [
    '../_base_/_datasets_/dota_ss_testmerge.py', '../_base_/schedules/schedule_1x.py',
...
# if with 2*A100 GPU: batch_size=2*4, lr=0.020
train_dataloader = dict(
    batch_size=4,
    num_workers=4)

test_evaluator = dict(
    outfile_prefix='./work_dirs/Task1_rotated-faster-rcnn-le90_r50_fpn_1x_dota')
